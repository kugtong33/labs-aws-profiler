...
```bash
mkdir -p ~/.local/bin
curl -fsSL https://raw.githubusercontent.com/ubuntu/labs-aws-profiler/0.1.0/awsprof -o ~/.local/bin/awsprof
...
- Installation Script: https://raw.githubusercontent.com/ubuntu/labs-aws-profiler/0.1.0/install.sh
